 ...
 * @property integer $ID_ASIENTOCONTABLE
...
class AsientoContable extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('ID_ASIENTOCONTABLE, NUMERO_COMPROBANTE, DEBE, HABER, CUENTA', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'ID_ASIENTOCONTABLE' => 'Id Asientocontable',
	...
	public function search()
	{
		...
		$criteria->compare('ID_ASIENTOCONTABLE',$this->ID_ASIENTOCONTABLE);
