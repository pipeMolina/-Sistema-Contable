 ...
 * @property string $NOMBRE_TIPOCOMP
 *
...
class TipoComprobante extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ID_TIPOCOMP', 'required'),
			array('ID_TIPOCOMP', 'numerical', 'integerOnly'=>true),
			array('NOMBRE_TIPOCOMP', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID_TIPOCOMP, NOMBRE_TIPOCOMP', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'comprobanteContables' => array(self::HAS_MANY, 'ComprobanteContable', 'ID_TIPOCOMP'),
		);
	}
	...
	{
		return array(
			'ID_TIPOCOMP' => 'Id Tipo comprobante',
			'NOMBRE_TIPOCOMP' => 'Nombre Tipo comprobante',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('NOMBRE_TIPOCOMP',$this->NOMBRE_TIPOCOMP,true);
