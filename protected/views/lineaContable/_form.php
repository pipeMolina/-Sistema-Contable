...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<div class="col-md-4">
			...
			<?php echo CHtml::link('Borrar', '#', array('onClick' => 'deleteLinea($(this));return false;')); ?>
			<?php echo $form->error($model,'CUENTA'); ?>
		</div>
		<div class="col-md-4">
			<?php echo $form->labelEx($model,'DEBE'); ?>
			<?php echo $form->textField($model,'DEBE',array("class"=>"form-control tagsinput")); ?>
