...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="form-group">
		...
		<div class="col-md-8">
			<?php echo $form->labelEx($model,'NOMBRE_REGION'); ?>
			<?php echo $form->textField($model,'NOMBRE_REGION',array("class"=>"form-control",'size'=>25,'maxlength'=>25)); ?>
			<?php echo $form->error($model,'NOMBRE_REGION'); ?>
		</div>
